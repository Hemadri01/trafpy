...
class DefaultBenchmark(Benchmark):
    def __init__(self, benchmark_name='social_media_cloud', benchmark_version='v001', load_prev_dists=True):
    ...
    def get_node_dist(self, eps, racks_dict=None, dist_name='node_dist'):
        ...
        if dist is None or not self.load_prev_dists:
            ...
            if racks_dict is None:
                ...
                rack_prob_config = {'racks_dict': racks_dict, 'prob_inter_rack': 1.0}    #Change -> 0.129
